...
def test_new_gridmet(gridmet_points, fields_join, gridmet_csv_dir, gridmet_ras):
    """This depends on running 'Raster Pixels to Points' on a WGS Gridmet raster,
     attributing GFID, lat, and lon in the attribute table, and saving to project crs: 5071.
     GFID is an arbitrary identifier e.g., @row_number. It further depends on projecting the
    ...
    for k, v in tqdm(gridmet_targets.items(), total=len_):
        ...
        for thredds_var, cols in CLIMATE_COLS.items():
            ...
            s = g.subset_nc_pt()  # It totally worked! But it takes much longer! Like 4 minutes for one variable?
...
def corrected_gridmet_db(con, gridmet_points, fields_join, gridmet_tb, gridmet_ras):
    ...
    #                      "NOT IN SELECT DISTINCT gfid FROM {} ".format(fields_join, gridmet_tb), con)
...
if __name__ == '__main__':
    ...
    # Should this be added as a separate variable? Or a global variable at the top?
    # con = sqlite3.connect("C:/Users/CND571/Documents/Data/tutorial.db")
    conec = sqlite3.connect("C:/Users/CND571/Documents/Data/opnt_analysis_02132024.db")
    ...
    cur.execute("CREATE TABLE {}(date, year, month, day, centroid_lat, centroid_lon, elev_m, tmin_c, tmax_c, "
                "prcp_mm, etr_mm, eto_mm, etr_mm_uncorr, eto_mm_uncorr, gfid)".format(gm_ts))
    ...
    for i in range(6):
        ...
        corrected_gridmet_db(conec, gridmet_cent, fields_db, gm_ts, rasters_)  # very long
    ...
    # fields_061 = "C:/Users/CND571/Documents/Data/061_mineral_county/061_mineral_fields_gfid.shp"
    # gmcsvdir = "C:/Users/CND571/Documents/Data/061_mineral_county/gridmet_timeseries_1"
    # test_new_gridmet(gridmet_cent, fields_061, gmcsvdir, rasters_)  # It worked! Poorly...
